...
const Detalle = ({carrito, setCarrito, producto, show, handleClose}) => {
        ...
        <Modal show={show} onHide={handleClose} size="xl">
            ...
            <Modal.Body>
                <div className='row'>
                    ...
                    <div className='col-md-6'> 
                        <h5><b>Nombre: </b>{producto.title}</h5>
                        <p><b>Categoria: </b>{producto.category}</p>
                        <p><b>Marca: </b>{producto.brand}</p>
                        <p><b>Existencia: </b>{producto.stock}</p>
                        <p><b>Puntuación: </b><Badge bg="danger">{producto.rating}</Badge></p>
                        <p><b>Descripción: </b>{producto.description}</p>
                        <h5 className='text-success'><b>Precio: </b>{producto.price}</h5>
                        <h5 className='text-success'><b>Descuento: </b>{producto.discountPercentage}</h5>
